...
//   return (
//     <>
//       <div className="fixed flex items-center justify-between py-3 px-8  bg-white shadow-md w-full overflow-hidden z-[990] top-0">
...
//           <div className="hidden md:flex md:ms-2 md:me-2 lg:m-0 social-icons  space-x-2 text-main">
//             <Link to={""}>
...
//             </Link>
//             <Link to={""}>
//               <i className="fa-brands fa-linkedin hover:opacity-75"></i>
//             </Link>
//             <Link to={""}>
//               <i className="fa-brands fa-tiktok hover:opacity-75"></i>
//             </Link>
//           </div>
//         <div>
...
//         className={
//           isOpen
//             ? "mobile-menu bg-[#F4D9D0]   mt-14 p-1 md:hidden"
...
//             <div className="space-x-2 text-main ">
//               <Link to={""}>
//                 <i className="fa-brands fa-facebook hover:opacity-75"></i>
//               </Link>
//               <Link to={""}>
