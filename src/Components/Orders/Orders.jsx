          ...
          <div key={index} className="my-5 px-3 sm:px-0">
            ...
            <div className="mt-10 flex flex-col  jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
              <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                <div className=" flex flex-col justify-start items-start rounded-md dark:bg-gray-800 bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full">
                  ...
                  {order.cartItems.map((item, index) => (
                    <div
                      key={index}
                      className="border-b border-gray-200 mt-4 md:mt-6 flex flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full"
                    >
                      <div className="pb-4 md:pb-8 w-full md:w-40">
                        <img
                          className="w-1/3 h-1/3 md:w-full   md:block"
                  ...
                  <div className="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 dark:bg-gray-800 space-y-6">
                    ...
                    <div className="flex flex-col justify-start  w-full">
                      <p className="text-lg leading-6 dark:text-white font-semibold text-gray-800">
                        Name: <span className="font-normal capitalize">
                          {order.user.name}
                        </span>
                      </p>
                      <p className="text-lg leading-6 dark:text-white font-semibold text-gray-800">
                      ...
                      <p className="text-lg leading-6 dark:text-white font-semibold text-gray-800">
                        Phone: <span className="font-normal">
                          {order.shippingAddress.phone}
                        </span>
                      </p>

                      <p className="text-lg leading-6 dark:text-white font-semibold text-gray-800">
                        City: <span className="font-normal capitalize">
                          {order.shippingAddress.city}
                        </span>
                      </p>
                      <p className="text-lg leading-6 dark:text-white font-semibold text-gray-800">
                        Address Details: <span className="font-normal capitalize">
