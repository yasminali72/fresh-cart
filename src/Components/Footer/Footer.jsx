...
export default function Footer() {
  ...
  <footer className="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100 dark:from-gray-800 dark:via-[#3b697b] dark:to-gray-800 ">
  <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8 ">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 ">
      ...
      <Link to={""} className="text-3xl font-bold text-main ">
        ...
        <div className="flex mt-8 space-x-6 text-main">
      ...
      <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <Link className="hover:opacity-75"  to={''}> History </Link>
            <Link className="hover:opacity-75"  to={''}> Careers </Link>
          </nav>
        </div>
        <div>
          <p className="font-medium">
